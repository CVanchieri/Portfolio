...
```
![CryptoToken2](https://cvanchieri.github.io/Portfolio/assets/images/CryptoTokenScraperPost/crypto2.png) <br>
(Token stats.)
    ...
    for addre in card_2.find_all('tr')[:6]:
        ...
        if addre.select_one('td:nth-child(1)') != None:
            ...
            if ': ' in holder_name.a.text:
                ...
                top_holders[rank[0]] = [holder[0], holder_hash[0], holder_hash_url[0], quantity[0], percentage[0], exchange[0]]
```
![CryptoToken3](https://cvanchieri.github.io/Portfolio/assets/images/CryptoTokenScraperPost/crypto5.png) <br>
(Holder info.)
...
for key, val in tweets_temp.items():
    if (val[0], val[1][10:20])  not in temp:
        ...
        continue
```
![CryptoToken4](https://cvanchieri.github.io/Portfolio/assets/images/CryptoTokenScraperPost/crypto4.png) <br>
(Twitter tweets.)
